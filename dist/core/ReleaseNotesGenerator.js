...
export class ReleaseNotesGenerator {
     ...
     */
    static generateReleaseNotes(versionAnalysis, impactAnalysis, commits) {
        const date = new Date();
     ...
     */
    static extractBreakingChanges(impact, commits) {
     ...
     */
    static extractFeatures(commits) {
        return commits
     ...
     */
    static extractBugFixes(commits) {
        return commits
            .filter(c => c.type === 'fix')
            .map(c => ({
            title: c.subject,
     ...
     */
    static generateMigrationGuide(version, impact) {
     ...
     */
    static generateChangelog(releases) {
        let changelog = '# Changelog\n\n';
        changelog += 'All notable changes to this project will be documented in this file.\n\n';
        for (const release of releases.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime())) {
