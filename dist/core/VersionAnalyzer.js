...
export class VersionAnalyzer {
     ...
     * major.minor.patch
     */
    static suggestVersion(currentVersion, commits) {
     ...
     */
    static isBreakingChange(fromVersion, toVersion) {
     ...
     */
    static generateReason(bump, breakingCount, featureCount, fixCount) {
        switch (bump) {
            case 'major':
...
//# sourceMappingURL=VersionAnalyzer.js.map