...
export class Nexus {
     ...
     */
    async analyzeImpactFromCommits(fromVersion, toVersion = 'HEAD') {
     ...
     */
    async generateReleaseNotes(fromVersion, toVersion = 'HEAD') {
        ...
        const releaseNotes = ReleaseNotesGenerator.generateReleaseNotes(versionAnalysis, impact, commits);
     ...
     */
    async fullAnalysis(fromVersion, toVersion = 'HEAD') {
